module Kuby::KubeDB::DSL::Api::V1
  class ObjectMeta < ::KubeDSL::DSLObject
    value_fields :uid, :deletion_timestamp, :cluster_name, :deletion_grace_period_seconds, :namespace, :generation, :generate_name, :resource_version, :creation_timestamp, :self_link, :name
